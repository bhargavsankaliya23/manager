...
module.exports = (app) => {
  ...
  app.use("/v1/role-master", cpUpload, require("../web/routes/v1/roleMaster"));
  app.use("/v1/csv", cpUpload, require("../web/routes/v1/csvUpload"));
  app.use("/v1/people-info", cpUpload, require("../web/routes/v1/peopleInfo"));
  app.use("/v1/job-position", cpUpload, require("../web/routes/v1/jobPositionMaster"));
  app.use("/v1/location-master", cpUpload, require("../web/routes/v1/locationMaster"));
