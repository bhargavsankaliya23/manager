...
class jobPositionMasterModel extends ModelBase {
    constructor() {
        super(CONFIG.DB.MONGO.DB_NAME, "Job-Position", {
            type: { type: String, allowNullEmpty: false },
...
module.exports = jobPositionMasterModel;