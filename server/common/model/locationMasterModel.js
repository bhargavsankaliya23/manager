...
class locationMasterModel extends ModelBase {
    constructor() {
        super(CONFIG.DB.MONGO.DB_NAME, "location-master", {
            name: { type: String, allowNullEmpty: true },
            outletType: { type: String, allowNullEmpty: true },
            email: { type: String, allowNullEmpty: true },
            fax: { type: String, allowNullEmpty: true },
            contactNo: { type: String, allowNullEmpty: true },
            address: { type: String, allowNullEmpty: true },
            country: { type: String, allowNullEmpty: true },
            state: { type: String, allowNullEmpty: true },
            postalCode: { type: String, allowNullEmpty: true },
...
module.exports = locationMasterModel;